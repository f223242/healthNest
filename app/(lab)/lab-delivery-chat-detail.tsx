...
const LabDeliveryChatDetail = () => {
  ...
  const deliveryName = params.deliveryName as string;
  const deliveryAvatar = params.deliveryAvatar as string;
  ...
  }, [user, deliveryId, deliveryName, deliveryAvatar]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          <Text style={styles.headerTitle}>{deliveryName}</Text>
          <Text style={styles.headerSubtitle}>Lab Delivery</Text>
        </View>
      </View>
      ...
      <ToraAIChat
        ...
        user={{
          _id: user?.uid || "",
          name: user?.firstname || "Lab Technician",
          avatar:
            user?.additionalInfo?.profileImage ||
            "https://via.placeholder.com/100",
        }}
